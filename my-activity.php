...
<header class="navbar sticky-top flex-md-nowrap p-3 shadow-sm" style="background-color:#0b4628;">
    <div class="d-flex align-items-center">
        <button class="navbar-toggler d-md-none me-3 border-white text-white" type="button"
    ...
    <div class="text-white d-flex align-items-center">
        ...
        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($fullName); ?>&background=0b5a30&color=fff"
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar offcanvas-md offcanvas-start bg-white border-end p-0">
            ...
            <div class="offcanvas-body d-flex flex-column p-3 flex-grow-1">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mb-2">
                        <a href="my-activity.php" class="nav-link d-flex align-items-center"
                           style="background-color:#d1e7dd; color:#0b4628;">
        ...
        <!-- Main -->
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 px-3 bg-light min-vh-100">

            <!-- Page header -->
            <div class="d-flex justify-content-between align-items-center pt-4 mb-4 posts-header">
                <h3 class="fw-bold mb-0">My Posts</h3>
                <a href="#" data-bs-toggle="modal" data-bs-target="#postItemModal"
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] === 'updated'): ?>
                <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
                    <i class="bi bi-check-circle me-2"></i> Item updated successfully.
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <?php endif; ?>

            <!-- Filter pills -->
            <div class="mb-4 filter-scroll-wrapper">
            ...
            <div class="row g-3">
                <?php if ($item_count > 0): ?>
                    <?php foreach($items as $row): ?>
                        ...
                        <div class="col-12">
                            <div class="item-card <?php echo strtolower($row['post_type']); ?>">

                                <!-- TOP ROW: thumbnail + details + desktop actions -->
                                <div class="card-top-row">
                                    ...
                                    <div class="card-thumb flex-shrink-0">
                                        ...
                                        <span class="badge position-absolute top-0 start-0 m-2
                                            <?php echo ($row['upload_status'] ?? 'pending') === 'approved'
                                                ? 'bg-success'
                                                : (($row['upload_status'] ?? 'pending') === 'rejected'
                                    ...
                                    <div class="card-details flex-grow-1">
                                        <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                            ...
                                            <?php if (!empty($row['post_type'])): ?>
                                                <span class="badge rounded-pill px-3 fw-semibold"
                                                      style="<?php echo strtolower($row['post_type']) === 'found'
                                        ...
                                        <div class="mb-2">
                                            <span class="badge border fw-normal"
                                                  style="border-color:#0b5a30 !important; color:#0b5a30;">
                                    ...
                                    <div class="card-actions-desktop gap-2 flex-shrink-0">
                                        <button type="button" class="btn btn-outline-secondary btn-sm px-3"
                                            ...
                                            data-submitted-to-office="<?php echo !empty($row['submitted_to_office']) ? 'true' : 'false'; ?>">
                                ...
                                <div class="card-actions-mobile">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-sm btn-edit-trigger"
                                        data-bs-toggle="modal" data-bs-target="#editItemModal"
                                        data-id="<?php echo $row['id']; ?>"
                                        data-name="<?php echo htmlspecialchars($row['item_name']); ?>"
                                        data-type="<?php echo $row['post_type']; ?>"
                        ...
                        <div class="col-md-6 d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-4 text-center d-flex flex-column align-items-center" id="upload-container"
                                     style="cursor:pointer; background:#f8f9fa; gap:0.75rem;"
                                    ...
                                    <img id="image-preview" src="" alt="Preview" class="img-fluid rounded d-none" style="max-height:150px; width:100%;">
                                    <input type="file" name="item_image" id="item_image" class="d-none" accept="image/*" required>
                ...
                <div class="modal-body p-4 pb-2">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small">Item Name *</label>
                                <input type="text" name="item_name" id="edit_item_name" class="form-control" placeholder="e.g., Black Cellphone" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold small">Category *</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small">Location *</label>
                                <input type="text" name="location_input" id="edit_location_input" class="form-control" placeholder="e.g., Library - 2nd Floor" required>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <label class="form-label fw-bold small">Date *</label>
                        ...
                        <div class="col-md-6 d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-4 text-center d-flex flex-column align-items-center" id="edit-upload-container"
                                     style="cursor:pointer; background:#f8f9fa; gap:0.75rem;"
                                     onclick="document.getElementById('edit_item_image').click()">
                                    <!-- placeholder hidden by default; shown only when no image -->
                                    <div id="edit-upload-placeholder" class="d-none">
                                        <i class="bi bi-upload fs-3 text-muted"></i>
                                        <p class="small text-muted mb-2">Click to upload or drag and drop<br>PNG, JPG, JPEG up to 5MB</p>
                                    </div>
                                    <img id="edit-image-preview" src="" alt="Preview" class="img-fluid rounded" style="max-height:150px; width:100%; display:none;">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (editModal) {
        editModal.addEventListener('show.bs.modal', function (event) {
            ...
            // FIX: populate all fields from data attributes fresh every open
            ...
            document.getElementById('edit_location_input').value = btn.dataset.location || '';
            ...
            // FIX: image preview — use inline style instead of d-none class to avoid conflicts
            const previewImg  = document.getElementById('edit-image-preview');
            const placeholder = document.getElementById('edit-upload-placeholder');
            const imgSrc      = btn.dataset.img || '';

            // Reset file input so previous selection doesn't linger
    ...
    // Also reset when post modal opens
