...
// FETCH ITEMS — paginated, only active tab
$stmt = $pdo->prepare("
...
// FETCH CATEGORIES for post modal
    ...
    <div class="offcanvas-body d-flex flex-column p-3">
        <ul class="nav nav-pills flex-column flex-grow-1">
            <li class="nav-item mb-2">
                <a href="admin-dash.php" class="nav-link d-flex align-items-center" style="background-color: #d1e7dd; color: #0b4628;">
                    <i class="bi bi-house-door-fill me-2"></i> Home
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="browse-item.php" class="nav-link d-flex align-items-center" style="color: #0b4628;">
                    ...
                    <div class="item-card">
                        ...
                        <div class="card-body-col">
                            <div class="d-flex align-items-center flex-wrap gap-2 mb-2">
                                ...
                                <!-- UPDATED: green for Found, red for Lost -->
                        ...
                        <div class="card-actions-col">
                            <?php if ($activeTab === 'pending'): ?>
                                <a href="actions/update_status.php?id=<?= (int)$item['id'] ?>&status=approved&redirect=pending"
                                   class="btn-approve">
                    ...
                    <nav class="mt-4" aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <?php if ($currentPage > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?tab=<?= $activeTab ?>&page=<?= $currentPage - 1 ?>">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-4 text-center d-flex flex-column align-items-center" id="admin-upload-container" style="cursor:pointer; background:#f8f9fa; gap: 0.75rem;"
                                    ...
                                    <img id="admin-image-preview" src="" alt="Preview"
                                         class="img-fluid rounded d-none" style="max-height: 150px; width: 100%;">
                                    <input type="file" name="item_image" id="admin_item_image"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const STATUS_CONFIG = {
        ...
        foundOffice: {
            ...
            body:   'This item has been turned over to the GNC Lost &amp; Found Management Office.',
        },
    };
    ...
    modalEl.addEventListener('show.bs.modal', function (event) {
        ...
        const cfg    = isLost                    ? STATUS_CONFIG.lost
                     : item.submitted_to_office  ? STATUS_CONFIG.foundOffice
