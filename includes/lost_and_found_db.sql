...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2026 at 09:09 AM
...
INSERT INTO `items` (`id`, `user_id`, `category_id`, `item_name`, `location_text`, `description`, `notes`, `item_img`, `time_last_seen`, `status`, `post_type`, `upload_status`, `item_resolved_status`, `contact_email`, `contact_phone`, `contact_num`, `date_reported`, `created_at`, `submitted_to_office`) VALUES
